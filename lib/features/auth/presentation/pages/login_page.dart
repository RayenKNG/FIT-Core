...
class _LoginPageState extends State<LoginPage> {
  ...
  void _handleResult(bool ok, AuthProvider auth) {
    if (ok) {
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (context.mounted) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Email reset sudah dikirim')),
                );
              }
            },
              ...
              child: Column(
                children: [
                  ...
                  const AuthHeader(
                    ...
                    subtitle: 'Masuk ke akun FITCORE kamu\ndan mulai latihan!',
                  ),
